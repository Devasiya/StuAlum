  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center space-x-4 ml-8">
        ...
        {showSignupDropdown && (
          <div className="absolute right-0 mt-30 w-40 bg-[#23232b] rounded-md shadow-lg z-50">
            <button
              className="block w-full px-4 py-2 text-left text-white hover:bg-purple-600"
